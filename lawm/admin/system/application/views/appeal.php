...
<div class="box-header">
    ...
    <h3 class="box-title"><?=$this->lang->line('appeal')?>:</h3>
</div><!-- /.box-header -->
<div class="box-body">
    <div style="width: 150px;text-align: right;float: right;">
        <input type="button" class="btn" value="Excel Download" onclick="getExcelDownload('appeal')">
    </div>
...
<tr>
    ...
    <th><?=$this->lang->line('appeal_type')?></th>
...
<?php for($s=0;$s<count($consultation_data);$s++){ ?>
    <tr>
        ...
        <td><?=$consultation_data[$s]['appeal_type']?></td>
        ...
        <td><div class="mod-more tooltipsample actions">
                <a id="edit" onclick="getServiceData(<?=$consultation_data[$s]['id_appeal']?>,'appeal')" title="edit" data-toggle="modal" data-target="#myModal1" class="edit" href="javascript:;"><span class="circle"><i class="fa fa-pencil"></i></span></a></a>
                </div>
        ...
        <form method="post" action="<?=ADMIN_BASE_URL?>index.php?welcome/ServiceDataUpdate" enctype="multipart/form-data" onsubmit="return validService(this);" >
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><?=$this->lang->line('edit_appeal')?></h4>
                </div>
                <div class="modal-body nav-tabs-custom" id="model-body">
                    ...
                    <div class="form-group" id="">
                        <label><?=$this->lang->line('appeal_type')?></label>
            ...
            <input type="hidden" name="type" id="type" value="appeal">
