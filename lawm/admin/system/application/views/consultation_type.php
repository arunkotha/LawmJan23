...
<div class="row">
    ...
    <div style="float: right; height: 35px; margin: 0px 30px 11px 0px; width: 150px;">
        <button onclick="" class="btn btn-primary" data-toggle="modal" data-target="#myModal" ><?=$this->lang->line('add_consultation_type')?></button>
    </div>
...
<div class="box-header">
    ...
    <h3 class="box-title"><?=$this->lang->line('consultation_type')?> :</h3>
</div><!-- /.box-header -->
<div class="box-body">
...
<tbody>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="post" action="<?=ADMIN_BASE_URL?>index.php?welcome/addConsultationType" enctype="multipart/form-data" onsubmit="return validConsultationType(this);" >
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                        <h4 class="modal-title" id="myModalLabel"><?=$this->lang->line('edit_consultation_type')?></h4>
                    </div>
                    <div class="modal-body nav-tabs-custom" id="model-body">

                        <div class="form-group" id="">
                            <label><?=$this->lang->line('title')?></label>
                            <input type="text" class="form-control" name="consultation_type" id="consultation_type" required>
                        </div>
                    ...
                    <input type="hidden" name="id_consultation_type" id="id_consultation_type">
                </div>
            </form>
        </div>
    </div>
