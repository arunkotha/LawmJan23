...
<div class="box-header">
    ...
    <h3 class="box-title"><?=$this->lang->line('contract_writing')?>:</h3>
</div><!-- /.box-header -->
<div class="box-body">
    ...
    <!--<select class="form-control input-sm" style="" name="category_ddl" id="category_ddl">
        ...
        <input type="button" class="btn" value="Excel Download" onclick="getExcelDownload('contractWriting')">
    </div>
...
<?php for($s=0;$s<count($consultation_data);$s++){ ?>
    <tr>
        ...
        <td><div class="mod-more tooltipsample actions">
                <a id="edit" onclick="getServiceData(<?=$consultation_data[$s]['id_contract_writing']?>,'contractWriting')" title="edit" data-toggle="modal" data-target="#myModal1" class="edit" href="javascript:;"><span class="circle"><i class="fa fa-pencil"></i></span></a></a>
                </div>
        ...
        <form method="post" action="<?=ADMIN_BASE_URL?>index.php?welcome/ServiceDataUpdate" enctype="multipart/form-data" onsubmit="return validService(this);" >
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><?=$this->lang->line('edit_contract_writing')?></h4>
                </div>
            ...
            <input type="hidden" name="type" id="type" value="contractWriting">
