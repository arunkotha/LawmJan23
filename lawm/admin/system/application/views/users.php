...
<div class="box-header">
    ...
    <h3 class="box-title"><?=$this->lang->line('users')?>:</h3>
</div><!-- /.box-header -->
<div class="box-body">
    ...
    <!--<select class="form-control input-sm" style="" name="category_ddl" id="category_ddl">
        ...
        <input type="button" class="btn" value="Excel Download" onclick="getExcelDownload('users')"/>
    </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><?=$this->lang->line('edit_user')?> </h4>
            </div>
            <form id="user_form" method="post" action="<?=ADMIN_BASE_URL?>index.php?welcome/updateUser/" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
                <button type="submit" onclick="validateUser()" class="btn btn-primary"><?=$this->lang->line('save')?> </button>
            </div>
