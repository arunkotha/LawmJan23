            ...
            <div class="profile-body">
                ...
                <div class="panel panel-profile">
                    ...
                    <div class="panel-heading overflow-h">
                        ...
                        <h2 class="panel-title heading-sm pull-left"><i class="fa fa-pencil"></i><?=$this->lang->line('direct_appeal')?></h2>
                                    ...
                                    <table class="table table-hover table-bordered table-striped <?php if($this->session->userdata('language_id')!=1){ echo "rtl"; } ?>">
                                        ...
                                        <?php for($s=0;$s<count($lawyer_consultation);$s++){ ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <!--<button class="btn-u btn btn-u-xs" onclick="updateAppeal('<?/*=$lawyer_consultation[$s]['id_appeal']*/?>','rejected')"> Decline</button>-->
                                                    <button class="btn-u btn btn-u-xs" data-toggle="modal" data-target="#view_module" onclick="getReject('<?=$lawyer_consultation[$s]['id_appeal']?>','appeal')"> <?=$this->lang->line('decline')?></button>

                                                    <button onclick="updateAppeal('<?=$lawyer_consultation[$s]['id_appeal']?>','accepted')" class="btn-u btn btn-u-xs"> <?=$this->lang->line('accept')?></button></td>
                                                <?php } else { ?>
                                                ...
                                                <td class="head1 attachement" style="text-align:center;">
                                                    ...
                                                    <?php
                                                    $attachment = $this->Mwelcome->getAttachment(array('type' => 'appeal','reference_id' => $lawyer_consultation[$s]['id_appeal']));
                                                    if(!empty($attachment)){
                                                ...
                                                <td>
                                                    <?php /*if($lawyer_consultation[$s]['status']=='accepted'){ */?><!--
                                                        <a href="<?/*=BASE_URL*/?>index.php/Welcome/comments/appeal/<?/*=$this->Mwelcome->encode($lawyer_consultation[$s]['id_appeal'])*/?>" ><i class="expand-list rounded-x fa fa-reply"></i></a>
                                                    <?php /*} */?>
                                                    <a data-target="#view_module" onclick="getModule('appeal','<?/*=$this->Mwelcome->encode($lawyer_consultation[$s]['id_appeal'])*/?>');" data-toggle="modal" href="javascript:;"  ><i class="expand-list rounded-x fa fa-eye"></i></a>-->
                                                    <a  class="btn-u btn btn-u-xs" style="color: white" href="<?=BASE_URL?>index.php/Welcome/comments/appeal/<?=$this->Mwelcome->encode($lawyer_consultation[$s]['id_appeal'])?>" ><?=$this->lang->line('view')?></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                    ...
                    <div class="col-sm-12 sm-margin-bottom-30">
                        ...
                        <div class="panel panel-profile">
                            ...
                            <div class="panel-heading overflow-h">
                                ...
                                <h2 class="panel-title heading-sm pull-left"><i class="fa fa-server"></i> <?=$this->lang->line('appeal')?></h2>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-hover table-bordered table-striped <?php if($this->session->userdata('language_id')!=1){ echo "rtl"; } ?>">
                                            ...
                                            <?php for($s=0;$s<count($other_consultation);$s++){ ?>
                                                <tr>
                                                    <td><a style="color:blue;" href="javascript:;" data-target="#view_module" data-toggle="modal" onclick="getModule('appeal','<?=$this->Mwelcome->encode($other_consultation[$s]['id_appeal'])?>');" href="javascript:;"><?=$other_consultation[$s]['user_name']?></a></td>
                                                    <td><a style="color:blue;" href="javascript:;" data-target="#view_module" data-toggle="modal" onclick="getModule('appeal','<?=$this->Mwelcome->encode($other_consultation[$s]['id_appeal'])?>');" href="javascript:;"><?=$other_consultation[$s]['subject']?></a></td>

                                                    <td class="td-width"><?=$other_consultation[$s]['created_date_time']?></td>
                                                    <td><button onclick="getPick('<?=$other_consultation[$s]['id_appeal']?>','appeal')" class="btn-u btn-u-blue btn-u-xs"> <?=$this->lang->line('pick')?></button>  </td>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div id="mail">
                                        ...
                                        <table class="table table-hover table-bordered table-striped open <?php if($this->session->userdata('language_id')!=1){ echo "rtl"; } ?>" style="border-collapse:collapse; margin-top:0px; width:100%;" border="0" cellpadding="5" cellspacing="3">
                                            ...
                                            <tbody>
                                            <?php $closed_cases = $this->Mwelcome->getAppeal(array('lawyer_id' => $this->session->userdata('user_id'),'status' => 'closed'));
                                            if(!empty($closed_cases)){
                                                for($s=0;$s<count($closed_cases);$s++){
                                                    $attachment = $this->Mwelcome->getAttachment(array('type' => 'appeal','reference_id' => $closed_cases[$s]['id_appeal']));
                                                    ?>
                                                    <tr>
                                                        ...
                                                        <td class="head0" style="text-align:left;">
                                                            <?php $rating = $this->Mwelcome->getRating(array('reference_type' => 'appeal','reference_id' => $closed_cases[$s]['id_appeal']));
                                                            if(!empty($rating)){
                                                                ?>
