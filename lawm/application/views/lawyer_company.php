            ...
            <div class="profile-body">
                ...
                <div class="panel panel-profile">
                    ...
                    <div class="panel-heading overflow-h">
                        ...
                        <h2 class="panel-title heading-sm pull-left"><i class="fa fa-pencil"></i><?=$this->lang->line('direct_establish_a_company')?></h2>

                        <!--<a href="Consultationlist.html" class="btn-u btn-brd btn-brd-hover btn-u-dark btn-u-xs pull-right">View All</a>-->
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-hover table-bordered table-striped <?php if($this->session->userdata('language_id')!=1){ echo "rtl"; } ?>">
                                        ...
                                        <tr>
                                            ...
                                            <th class="hidden-sm"><?=$this->lang->line('date_time')?></th>
                                        ...
                                        <?php for($s=0;$s<count($lawyer_consultation);$s++){ ?>
                                            <tr>
                                                ...
                                                <td class="td-width"><?=$lawyer_consultation[$s]['date']?></td>
                                                <?php if($lawyer_consultation[$s]['status']=='pending'){ ?>
                                                <td>
                                                    <!--<button class="btn-u btn btn-u-xs" onclick="updateEstablishCompany('<?/*=$lawyer_consultation[$s]['id_company']*/?>','rejected')"> Decline</button>-->
                                                    <button class="btn-u btn btn-u-xs" data-toggle="modal" data-target="#view_module" onclick="getReject('<?=$lawyer_consultation[$s]['id_company']?>','company')"> <?=$this->lang->line('decline')?></button>

                                                    <button onclick="updateEstablishCompany('<?=$lawyer_consultation[$s]['id_company']?>','accepted')" class="btn-u btn btn-u-xs"> <?=$this->lang->line('accept')?></button></td>
                                                <?php } else { ?>
                                                ...
                                                <td class="head1 attachement" style="text-align:center;">
                                                    ...
                                                    <?php
                                                    $attachment = $this->Mwelcome->getAttachment(array('type' => 'company','reference_id' => $lawyer_consultation[$s]['id_company']));
                                                    if(!empty($attachment)){
                                                ...
                                                <td>
                                                    <?php /*if($lawyer_consultation[$s]['status']=='accepted'){ */?><!--
                                                        <a href="<?/*=BASE_URL*/?>index.php/Welcome/comments/company/<?/*=$this->Mwelcome->encode($lawyer_consultation[$s]['id_company'])*/?>" ><i class="expand-list rounded-x fa fa-reply"></i></a>
                                                    <?php /*} */?>
                                                    <a data-target="#view_module" onclick="getModule('company','<?/*=$this->Mwelcome->encode($lawyer_consultation[$s]['id_company'])*/?>');" data-toggle="modal" href="javascript:;"  ><i class="expand-list rounded-x fa fa-eye"></i></a>-->
                                                    <a  class="btn-u btn btn-u-xs" style="color: white" href="<?=BASE_URL?>index.php/Welcome/comments/company/<?=$this->Mwelcome->encode($lawyer_consultation[$s]['id_company'])?>" ><?=$this->lang->line('view')?></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                    ...
                    <div class="col-sm-12 sm-margin-bottom-30">
                        ...
                        <div class="panel panel-profile">
                            ...
                            <div class="panel-heading overflow-h">
                                ...
                                <h2 class="panel-title heading-sm pull-left"><i class="fa fa-server"></i> <?=$this->lang->line('establish_a_company_all')?></h2>
                                        ...
                                        <table class="table table-hover table-bordered table-striped <?php if($this->session->userdata('language_id')!=1){ echo "rtl"; } ?>">
                                            ...
                                            <?php for($s=0;$s<count($other_consultation);$s++){ ?>
                                                <tr>
                                                    ...
                                                    <td><a style="color:blue;" href="javascript:;" data-target="#view_module" data-toggle="modal" onclick="getModule('company','<?=$this->Mwelcome->encode($other_consultation[$s]['id_company'])?>');" href="javascript:;"> <?=$other_consultation[$s]['user_name']?></a></td>
                                                    <td><a style="color:blue;" href="javascript:;" data-target="#view_module" data-toggle="modal" onclick="getModule('company','<?=$this->Mwelcome->encode($other_consultation[$s]['id_company'])?>');" href="javascript:;"> <?=$other_consultation[$s]['subject']?></a></td>
                                                    <td class="td-width"><?=$other_consultation[$s]['date']?></td>
                                                    <td><button onclick="getPick('<?=$other_consultation[$s]['id_company']?>','company')" class="btn-u btn-u-blue btn-u-xs"> <?=$this->lang->line('pick')?></button>  </td>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div id="mail">
                                        ...
                                        <table class="table table-hover table-bordered table-striped open <?php if($this->session->userdata('language_id')!=1){ echo "rtl"; } ?>" style="border-collapse:collapse; margin-top:0px; width:100%;" border="0" cellpadding="5" cellspacing="3">
                                            ...
                                            <tbody>
                                            <?php $closed_cases = $this->Mwelcome->getEstablishCompany(array('lawyer_id' => $this->session->userdata('user_id'),'status' => 'closed'));
                                            if(!empty($closed_cases)){
                                                for($s=0;$s<count($closed_cases);$s++){
                                                    $attachment = $this->Mwelcome->getAttachment(array('type' => 'company','reference_id' => $closed_cases[$s]['id_company']));
                                                    ?>
                                                    <tr>
                                                        ...
                                                        <td class="head0" style="text-align:left;">
                                                            <?php $rating = $this->Mwelcome->getRating(array('reference_type' => 'company','reference_id' => $closed_cases[$s]['id_company']));
                                                            if(!empty($rating)){
                                                                ?>
